...
export async function registerApiRoutes(fastify) {
  ...
  fastify.put('/api/rooms/:room_slug', async (request, reply) => {
  ...
  fastify.get('/api/rooms/:room_slug', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.post('/api/rooms/:room_slug/publishers', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.get('/api/rooms/:room_slug/publishers', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.put('/api/rooms/:room_slug/publishers/:id', async (request, reply) => {
  ...
  fastify.delete('/api/rooms/:room_slug/publishers/:id', async (request, reply) => {
    const { room_slug, id } = request.params;
  ...
  fastify.delete('/api/rooms/:room_slug', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.post('/api/rooms/:room_slug/recordings/start', async (request, reply) => {
    const { room_slug } = request.params;
    ...
    try {
      ...
      const result = await startRecording(room_slug, room.id);
      ...
      if (request.server.notifyRecordingStatusChange) {
        request.server.notifyRecordingStatusChange(room.slug, {
          isRecording: true,
          recordingId: result.recordingId,
          folderName: result.folderName,
  ...
  fastify.post('/api/rooms/:room_slug/recordings/stop', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.get('/api/rooms/:room_slug/recordings/status', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.get('/api/rooms/:room_slug/recordings', async (request, reply) => {
    const { room_slug } = request.params;
  ...
  fastify.get('/api/rooms/:room_slug/transcriptions/current', async (request, reply) => {
    const { room_slug } = request.params;
    try {
      const room = getRoomBySlug(room_slug);
      if (!room) {
  ...
  fastify.get('/api/rooms/:room_slug/transcriptions/sessions', async (request, reply) => {
    const { room_slug } = request.params;
    try {
      const room = getRoomBySlug(room_slug);
      if (!room) {
  ...
  fastify.get('/api/rooms/:room_slug/transcriptions/sessions/:session_id', async (request, reply) => {
  ...
  fastify.get('/api/rooms/:room_slug/transcriptions/sessions/:session_id/channels/:channel_name', async (request, reply) => {
  ...
  fastify.post('/api/rooms/:room_slug/transcriptions/sessions/:session_id/stop', async (request, reply) => {
    const { room_slug, session_id } = request.params;
    ...
    try {
      ...
      if (request.server.notifyRecordingStatusChange) {
        const status = getRecordingStatus(room.id);
        request.server.notifyRecordingStatusChange(room.slug, status || { isRecording: false });
      }
  ...
  fastify.post('/api/rooms/:room_slug/transcriptions/channels/:channel_name/restart', async (request, reply) => {
  ...
  fastify.get('/api/rooms/:room_slug/transcriptions/channels/:channel_name', async (request, reply) => {
    const { room_slug, channel_name } = request.params;
    try {
      const room = getRoomBySlug(room_slug);
      if (!room) {
